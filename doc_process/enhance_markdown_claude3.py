...
if __name__ == '__main__':
    ...
    parser.add_argument('--prefix', type=str, default='', help='input bucket')
    parser.add_argument('--input_path', type=str, default='./output', help='input path')
    parser.add_argument('--output_path', type=str, default='./out_excel', help='output path')
    ...
    session = boto3.Session(profile_name="corp-us-east-1", region_name=region)
